...
<head>
    ...
    <style>
        ...
        /* Animasi pop-up untuk modal lacak paket */
    ...
    <div class="p-8 max-w-7xl mx-auto">
            ...
            <div class="mb-8">
                <div class="bg-emerald-50 border border-emerald-200 text-emerald-800 px-6 py-4 rounded-xl relative flex flex-col md:flex-row items-start md:items-center justify-between gap-4 shadow-sm">
                    ...
                    <button onclick="document.getElementById('modal-lacak').classList.remove('hidden')" class="bg-emerald-600 hover:bg-emerald-700 text-white px-5 py-2.5 rounded-xl font-bold text-sm transition shadow-sm whitespace-nowrap flex items-center gap-2">
                        <i class="fa-solid fa-truck-fast"></i> Lacak Paket Saya
                    </button>
                </div>
            </div>

            <div id="modal-lacak" class="fixed inset-0 z-[100] hidden flex items-center justify-center p-4 bg-gray-900/50 backdrop-blur-sm transition-opacity">
                <div class="bg-white rounded-3xl w-full max-w-md p-6 md:p-8 shadow-2xl relative modal-masuk">
                    ...
                    <div class="relative border-l-2 border-gray-200 ml-3 md:ml-4 space-y-8 mt-4 mb-8">
                        
                        <div class="relative pl-6">
                            <div class="absolute -left-[9px] top-1 w-4 h-4 rounded-full bg-gray-200 border-2 border-white"></div>
                            <p class="text-sm font-bold text-gray-400">Paket Tiba di Tujuan</p>
                            <p class="text-xs text-gray-400 mt-1">Menunggu pembaruan...</p>
                        </div>

                        <div class="relative pl-6">
                            <div class="absolute -left-[9px] top-1 w-4 h-4 rounded-full bg-gray-200 border-2 border-white"></div>
                            <p class="text-sm font-bold text-gray-400">Sedang Dikirim</p>
                            <p class="text-xs text-gray-400 mt-1">Kurir sedang menuju alamat tujuan.</p>
                        </div>

                        <div class="relative pl-6">
                            <div class="absolute -left-[11px] -top-1 w-5 h-5 rounded-full bg-rose-500 border-4 border-white shadow-sm"></div>
                            <p class="text-sm font-bold text-rose-600">Pesanan Diproses <span class="bg-rose-100 text-rose-600 text-[10px] px-2 py-0.5 rounded ml-2">Saat ini</span></p>
                            <p class="text-xs text-gray-500 mt-1 leading-relaxed">Tim Glow Beauty sedang mengemas pesananmu dengan aman. Tunggu sebentar ya!</p>
                        </div>
                    </div>

                    <button onclick="document.getElementById('modal-lacak').classList.add('hidden')" class="w-full bg-gray-100 text-gray-700 font-bold py-3 rounded-xl hover:bg-gray-200 transition">Tutup Peta</button>
                </div>
            </div>
            @endif
