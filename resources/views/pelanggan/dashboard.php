...
<body class="bg-rose-50 font-[Poppins]">
    ...
    <div class="flex items-center gap-6">
        ...
        <form method="POST" action="{{ route('logout') }}"> 
            ...
            <button class="text-rose-600 font-bold text-sm">Logout</button> 
        </form>
    </div>
</nav>
</nav>
...
<div class="grid grid-cols-2 md:grid-cols-4 gap-6">
   ...
   <script>
    ...
    // 1. FUNGSI KERANJANG (Klik tombol +)
    ...
    document.querySelectorAll('.btn-wish').forEach(button => {
        button.addEventListener('click', function(e) {
            ...
            // Munculkan badge jika angka > 0, sembunyikan jika 0
            if (jumlahWishlist > 0) {
